<template>
  <div class="banner-box" @mouseover="clearRunInv" @mouseout="runInv">
      ...
      <div class="page">
              <ul>
                  <li><span @click="goto(prevIndex)">&lt;</span></li>
                  <li v-for="(item,index) in banners.length" :key="index"><a @click="goto(index)" :class="{on: index === nowIndex}" href="javascript:;">{{index}}</a></li>
                  <li><span @click="goto(nextIndex)">&gt;</span></li>
              </ul>
          </div>
  </div>
</template>
